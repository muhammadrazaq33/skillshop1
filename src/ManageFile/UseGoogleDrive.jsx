    ...
    <div>
      ...
      <div className="max-w-[960px] w-[92vw] m-auto mt-[2.3rem] sm:mt-[4rem]">
        ...
        <div className="relative">
          <button
            onClick={() => setShow(1)}
            className="bg-[#dadce099] absolute top-[13.6%] left-[30%] w-[50px] overflow-visible cursor-pointer h-[50px] rounded-[50%] grid place-content-center hover:text-[white] hover:bg-[#1A73E8] sm:p-8 text-[20px]"
          >
            1
          </button>
          <button
            onClick={() => setShow(2)}
            className="bg-[#dadce099] text-[20px] sm:p-8 hover:bg-[#1A73E8] hover:text-[white] absolute top-[54.5%] left-[54%] w-[50px] overflow-visible cursor-pointer h-[50px] rounded-[50%] grid place-content-center"
          >
            2
          </button>
      ...
      <div className="bg-[#F9F9FA] pb-16 pt-20 top-shadow">
        <div className="max-w-[960px] w-[92vw] m-auto">
          ...
          <p className="mt-7">Watch this video to learn more.</p>
